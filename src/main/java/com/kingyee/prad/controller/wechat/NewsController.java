...
import com.kingyee.prad.mapper.PradCommentMapper;
import com.kingyee.prad.model.NewsCommentModel;
import com.kingyee.prad.service.*;
 ...
 */
@Controller
@RequestMapping(value = "/wechat/news")
public class NewsController {
    ...
    public String getNewsById(ModelMap mm, Long newsId, HttpServletRequest request) {
        try {
            ...
            if (news != null) {
                ...
                if (catId != null) {
                    ...
                    if (NewsCategoryConstant.DOCTOR_RESOURCES.equals(category.getNcPid())) {
                        return "redirect:/wechat/resources/detail?pk=" + news.getNeId();
                    }
                }
            ...
            return "wechat/front/newsDetail";
        }catch (Exception e){
            e.printStackTrace();
