...
public class WxMenuController {
    ...
    public String menuCreateSample() throws WxErrorException, MalformedURLException {
        ...
        button1.setName("探·泌天地");
		button1.setUrl(domain + "/wechat/front/index");




        WxMenuButton button2 = new WxMenuButton();
        button2.setName("探·泌资源");

        WxMenuButton button21 = new WxMenuButton();
		button21.setType(MenuButtonType.VIEW);
		button21.setName("理论前沿");
		button21.setUrl(domain + "/wechat/front/category?categoryId=1");

        WxMenuButton button22 = new WxMenuButton();
		button22.setType(MenuButtonType.VIEW);
		button22.setName("MDT甄选");
		button22.setUrl(domain + "/wechat/resources/index");
        ...
        button3.setName("探·泌工具");

        WxMenuButton button31 = new WxMenuButton();
        button31.setType(MenuButtonType.VIEW);
		button31.setName("医学工具");
		button31.setUrl(domain + "/wechat/tools/index");

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(MenuButtonType.VIEW);
        button32.setName("OMES会议平台");
        button32.setUrl(domain + "/wechat/tools/meeting");

		WxMenuButton button33 = new WxMenuButton();
		button33.setType(MenuButtonType.VIEW);
		button33.setName("个人中心");
		button33.setUrl(domain + "/wechat/userCenter/center");
